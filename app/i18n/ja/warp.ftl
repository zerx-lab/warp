...
sftp-error-upload = アップロードに失敗しました: { $error }
sftp-error-upload-not-connected = アップロードに失敗しました: サーバーに接続されていません
sftp-error-download = ダウンロードに失敗しました: { $error }
sftp-error-download-not-connected = ダウンロードに失敗しました: サーバーに接続されていません
sftp-ops-error-connection = 接続エラー: { $detail }
sftp-ops-error-operation = 操作エラー: { $detail }
sftp-ops-error-local-io = ローカル IO エラー: { $detail }
sftp-ops-error-no-credentials = 認証情報が見つかりません: { $detail }
sftp-ops-error-cancelled = 転送がキャンセルされました
cloud-sync-error-crypto = 暗号化エラー: { $detail }
cloud-sync-error-gist = Gist エラー: { $detail }
cloud-sync-error-provider = データプロバイダーエラー: { $detail }
cloud-sync-error-serialization = シリアライズエラー: { $detail }
cloud-sync-error-version-store = バージョンストアエラー: { $detail }
cloud-sync-gist-error-request = ネットワークリクエストに失敗しました: { $detail }
cloud-sync-gist-error-not-found = Gist が見つかりません
cloud-sync-gist-error-no-token = トークンが設定されていません
cloud-sync-gist-error-api = API エラー: { $status } { $body }
